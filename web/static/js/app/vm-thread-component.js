(function() {
    ...
    Dropwizard.mainDashboard.addPageComponent({
        ...
        beforeSocketConnect : function() {
            Dropwizard.mainDashboard.installRemoteTemplate("thread-template", "/static/templates/threads.html");
            Dropwizard.mainDashboard.appendTemplateTo("thread-template", document.getElementById(component.dom_id));
